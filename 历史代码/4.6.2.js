          ...
          <form id="generatorForm">
            ...
            <div id="passwordConfig">
              ...
              <div class="checkbox-group">
                <label><input type="checkbox" name="uppercase" checked><span class="label-text">Uppercase</span></label>
                <label><input type="checkbox" name="lowercase" checked><span class="label-text">Lowercase</span></label>
                <label><input type="checkbox" name="numbers" checked><span class="label-text">Numbers</span></label>
                <label><input type="checkbox" name="symbols" checked><span class="label-text">Symbols</span></label>
              </div>
            </div>
